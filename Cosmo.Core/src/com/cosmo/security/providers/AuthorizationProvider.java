...
public abstract class AuthorizationProvider 
{
    ...
    * @throws UserProviderException 
    */
   public static AuthorizationProvider getInstance(Workspace workspace) throws UserProviderException 
   {
      if (instance == null) 
      {
    ...
    * @throws UserProviderException 
    */
   private static AuthorizationProvider loadProvider(Workspace workspace) throws UserProviderException
   {
