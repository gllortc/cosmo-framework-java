 ...
 * @author Gerard Llort
 */
public class FormFieldUrl extends FormField
{
    ...
    * @param label Etiqueta que se mostrará junto el control.
    */
   public FormFieldUrl(String name, String label, boolean required) 
   {
      this.name = name;
      this.label = label;
      this.description = StringUtils.EMPTY;
    ...
    */
   public FormFieldUrl(String name, String label, int maxLength) 
   {
      this.name = name;
      this.label = label;
      this.description = StringUtils.EMPTY;
    ...
    */
   public FormFieldUrl(String name, String label, int maxLength, boolean required) 
   {
      this.name = name;
      this.label = label;
      this.description = StringUtils.EMPTY;
