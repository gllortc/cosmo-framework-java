 ...
 * href="http://fontawesome.io/icons/">http://fontawesome.io/icons/</a>.
 * 
 * @author Gerard Llort
 */
public class Icon
{
    ...
    * Renderiza un icono.
    * 
    * @param image Una cadena que contiene el identificador de la imagen (constante
    *    {@code ICON_IMAGE_XXXX}).
    * @param size Una cadena que contiene el identificador del tamaño (constante
    *    {@code ICON_SIZE_XXXX}).
    * @param color Una cadena que contiene el identificador del color (constante
    *    {@code ICON_COLOR_XXXX}).
    * 
