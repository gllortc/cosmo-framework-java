...
public class SecretPage extends Page 
{
   ...
   public void initPageEvent(HttpServletRequest request, HttpServletResponse response) 
   {
      ...
      navbar.addItem(new BreadcrumbsItem("Private page", ""));
      this.addContent(navbar, ContentColumns.MAIN);
      
      HeaderControl header = new HeaderControl(getWorkspace());
      header.setTitle("Pàgina privada");
      header.setDescription("Exemple de pàgina que precisa d'una sessió d'usuari oberta.");
