...
@CormObject(formName = "frmTravel", dbTable = "travel", title = "Viajes", description = "Gestión de excursiones.")
public class Travel
{
   private Integer id;
   private String  name;
   ...
   @CormObjectField(fieldClass = FormFieldText.class, dbTableColumn = "name", label = "Título", showInObjectListGrid = true)
   ...
   @CormObjectField(fieldClass = FormFieldTextArea.class, dbTableColumn = "description", label = "Descripción")
